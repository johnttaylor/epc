...
TEST_CASE( "House" )
{
    ...
    {
        House  uut( 1.0, 80.0, 120.0, 20.0, 0.33, 0.80 );
        double idt = 0.0;
        int    i   = 0;
    ...
    {
        House  uut( 1.0, 60, 120.0, 20.0, 0.33, 0.80 );
        double idt = 0.0;
        int    i   = 0;
        while ( ( idt > 70.1 || idt < 69.9 ) && i < MAX_LIMIT )
        {
    ...
    {
        House  uut( 1.0, 90, 120.0, 20.0, 0.33, 0.80 );
        double idt = 0.0;
        int    i   = 0;
        while ( ( idt > 70.1 || idt < 69.9 ) && i < MAX_LIMIT )
        {
    ...
    {
        House  uut( 1.0, 20, 120.0, 20.0, 0.33, 0.80 );
        double idt = 0.0;
        int    i   = 0;
        while ( ( idt > 70.1 || idt < 69.9 ) && i < MAX_LIMIT )
        {
