...
unit_test_objects = '_BUILT_DIR_.src/Ajax/Heating/Supervisor/_0test'
...
base_win32.cflags    = '-m32 -std=c++17 -Wall -Werror -x c++  -fprofile-arcs -ftest-coverage -DCATCH_CONFIG_FAST_COMPILE'
