...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOF, LCD_DC_Pin|LCD_RESET_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = BUTTON_A_Pin|BUTTON_Y_Pin;
  ...
  GPIO_InitStruct.Pin = BUTTON_B_Pin|BUTTON_X_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIOE, &GPIO_InitStruct);
  ...
  /*Configure GPIO pin : PtPin */
  GPIO_InitStruct.Pin = HW_SAFETY_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(HW_SAFETY_GPIO_Port, &GPIO_InitStruct);
