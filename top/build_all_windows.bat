...
::
:: Build Aruduino Target projects
::

call %_ROOT%\env.bat 4
@echo on

:: Build NON-unit-test projects
cd %_ROOT%\projects
%_TOOLS%\bob.py -v4 --p2 windows gcc --bldtime -c --bld-all --bldnum %BUILD_NUMBER%
IF ERRORLEVEL 1 EXIT /b 1
...
cd %_ROOT%\projects
%_TOOLS%\bob.py -v4 --p2 windows gcc --bldtime -cg --bld-all --bldnum %BUILD_NUMBER%
IF ERRORLEVEL 1 EXIT /b 1
