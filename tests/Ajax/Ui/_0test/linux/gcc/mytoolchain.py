...
unit_test_objects = '_BUILT_DIR_.src/Ajax/Ui/_0test'
...
base_release.cflags    = ' -Wno-class-memaccess -m32 -std=c++17 -Wall -Werror -x c++ -fprofile-arcs -ftest-coverage -DCATCH_CONFIG_FAST_COMPILE'
...
# Set 'base' options
base_cpp11.cflags     = ' -Wno-class-memaccess -m64 -std=c++17 -Wall -Werror -x c++ -fprofile-arcs -ftest-coverage -DCATCH_CONFIG_FAST_COMPILE'
base_cpp11 .inc       = f'{pimoroni_inc}'
...
# Set project specific 'base' (i.e always used) options
base_posix64.cflags    = ' -Wno-class-memaccess -m64 -std=c++17 -Wall -Werror -x c++ -fprofile-arcs -ftest-coverage -DCATCH_CONFIG_FAST_COMPILE'
