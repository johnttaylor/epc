...
base_posix32.cflags    = '-m32 -std=c++17 -Wall -Werror -x c++ -fprofile-arcs -ftest-coverage -Wno-class-memaccess'
...
# Set project specific 'base' (i.e always used) options
base_posix64.cflags    = '-m64 -std=c++17 -Wall -Werror -x c++ -fprofile-arcs -ftest-coverage -Wno-class-memaccess'
